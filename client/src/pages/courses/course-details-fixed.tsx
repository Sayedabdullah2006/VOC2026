...
export default function CourseDetailsPage() {
  ...
  console.log('Start date type:', typeof course.start_date, 'Value:', course.start_date);
  console.log('End date type:', typeof course.end_date, 'Value:', course.end_date);
              ...
              <div>
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="flex items-center gap-2 text-white/90">
                    ...
                    <span>{formatSafeDate(course.start_date)}</span>
                  </div>
                  <div className="flex items-center gap-2 text-white/90">
                  ...
                  <div className="grid md:grid-cols-2 gap-y-6 gap-x-12">
                    <div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div><strong>البداية:</strong> {formatSafeDate(course.start_date)}</div>
                          <div><strong>النهاية:</strong> {formatSafeDate(course.end_date)}</div>
                        </div>
                      </div>
                    </div>
                    <div>

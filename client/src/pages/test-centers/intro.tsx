...
export default function TestCenterIntro() {
  return (
    <div className="min-h-screen" dir="rtl">
      ...
      <div className="relative py-16 overflow-hidden">
        <div className="absolute inset-0 gradient-green-blue opacity-90"></div>
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=1000')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl font-bold mb-6 text-white">خدمة اعتماد مراكز الاختبار</h1>
              <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
                خدمة تتيح لمراكز الاختبار تقديم طلب اعتماد لدى الهيئة العامة للنقل لممارسة نشاط الاختبار للسائقين ومدراء التشغيل
              </p>
              <div className="flex justify-center">
                <Link href="/test-centers/register">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="p-3 bg-[#0C7D99]/10 rounded-lg">
                        <Award className="h-6 w-6 text-[#0C7D99]" />
                      </div>
                    ...
                    <ul className="space-y-4">
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>معايير موحدة لتقييم الكفاءة</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <Target className="h-5 w-5 text-[#0C7D99] mt-1" />
                        <span>نظام إدارة متكامل للاختبارات</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        <p>سجل تجاري يتضمن نشاط اختبار</p>
                      </div>
                      <div className="flex items-start gap-4">
                        <CheckCircle className="h-5 w-5 text-[#0D9C65] mt-1 shrink-0" />
                      ...
                      <div className="flex items-start gap-4">
                        <CheckCircle className="h-5 w-5 text-[#0D9C65] mt-1 shrink-0" />
                        <p>توفير مركز مناسب وفق شروط وإجراءات تأهيل واعتماد مراكز الاختبار</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
                        <FileText className="h-5 w-5 text-[#0C7D99]" />
                        <span>ترخيص مزاولة نشاط الاختبار</span>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
                        <FileText className="h-5 w-5 text-[#0C7D99]" />

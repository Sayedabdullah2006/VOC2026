...
// بيانات المراكز من الملف المرفق
...
const TestCentersSearch = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col" dir="rtl">
      ...
      {/* Page Header Section */}
      <div className="pt-24 pb-32 bg-gradient-to-l from-primary/80 to-primary relative overflow-hidden">
                      ...
                      {filteredCenters.map((center) => (
                        ...
                        >
                          <Card className="overflow-hidden group hover:shadow-lg transition-all duration-300 h-full border border-border/40">
                            <div className="h-2 bg-gradient-to-l from-primary/80 to-primary group-hover:h-3 transition-all"></div>
                              ...
                              {center.website && (
                                <div className="mt-5 pt-4 border-t border-border/30 text-center">
                                  <Button
                                    variant="default"
                                    size="sm"
                                    className="w-full flex flex-row-reverse justify-center bg-primary/90 hover:bg-primary transition-colors"

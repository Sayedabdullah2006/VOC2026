...
export default function TestingCentersSearchIntroPage() {
  const { user } = useAuth();
        ...
        <Card className="w-full max-w-4xl bg-white/10 backdrop-blur-sm border-white/20 shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-white/90 text-lg">
              استعراض وتصفح مراكز الاختبار المعتمدة في المملكة
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-8 text-white">
            <div className="p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
              ...
              <p className="leading-relaxed">
                مراكز الاختبار المعتمدة تقدم خدمات متعددة للعثور على المركز
                الأقرب والأنسب لاحتياجاتك.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0D9C65]/20 rounded-full items-center justify-center mt-0.5">✓</span>
                    <span>تصفية حسب نوع الاختبارات المتوفرة</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0D9C65]/20 rounded-full items-center justify-center mt-0.5">✓</span>
                    <span>عرض مواعيد الاختبارات المتاحة</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0D9C65]/20 rounded-full items-center justify-center mt-0.5">✓</span>
                    <span>معلومات تفصيلية عن المركز</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0D9C65]/20 rounded-full items-center justify-center mt-0.5">✓</span>
              ...
              <div className="p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>العنوان وتفاصيل الوصول</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0C7D99]/20 rounded-full items-center justify-center mt-0.5">•</span>
                    <span>أنواع الاختبارات المقدمة</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0C7D99]/20 rounded-full items-center justify-center mt-0.5">•</span>
                    <span>ساعات العمل ومواعيد الاختبارات</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0C7D99]/20 rounded-full items-center justify-center mt-0.5">•</span>
                    <span>متطلبات التقدم للاختبار</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex w-5 h-5 bg-[#0C7D99]/20 rounded-full items-center justify-center mt-0.5">•</span>
                    <span>الرسوم والمستندات المطلوبة</span>
                  </li>
                </ul>
              </div>
            </div>
